...
class ComplexSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $users = [
            ...
            ['name' => 'Traveler User', 'email' => 'traveler@example.com', 'role' => 'finance'], // sementara assign finance
            ['name' => 'Customer User', 'email' => 'customer@example.com', 'role' => 'finance'], // sementara assign finance
        ];
